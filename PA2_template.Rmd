...
barplot(height = fatality[1:10], cex.axis = 0.75, cex.name = 0.7, las = 2, main = "Top 10 Most Harmful Events for Fatality Across the US")
mtext(text = "Events Types",side =1, line = 6)
mtext(text = "No of Fatality", side = 2, line = 4)
...
barplot(height = injury[1:10], cex.axis = 0.75, cex.name = 0.7, las = 2, main = "Top 10 Most Harmful Events for Injury Across the US")
mtext(text = "Events Types",side =1, line = 6)
mtext(text = "No of Injury", side = 2, line = 4)
```
...
barplot(height = propdmg[1:10], cex.axis = 0.75, cex.name = 0.7, las = 2, main = "Top 10 Greatest Economic Consequences Events Across the US (Property)")
mtext(text = "Events Types",side =1, line = 6)
...
barplot(height = cropdmg[1:10], cex.axis = 0.75, cex.name = 0.7, las = 2, main = "Top 10 Greatest Economic Consequences Events Across the US (Crop)")
mtext(text = "Events Types",side =1, line = 6)
